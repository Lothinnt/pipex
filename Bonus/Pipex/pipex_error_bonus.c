...
/*   Updated: 2024/05/08 19:39:20 by lothin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	exit_main(int p_fd[2], int need_close, int error_code)
{
	...
	if (error_code == 1)
	{
		...
		print_error_in_red("Usage 1: ./pipex_bonus here_doc limiter cmd1");
		print_error_in_red(" cmd2 file\n");
		print_error_in_red("\n");
		print_error_in_red("Usage 2: ./pipex_bonus file1 cmd1 cm2 cm.. file2");
		print_error_in_red("\n");
	}
